...
const Footer = () => {
    return (
        <div className='bg-black text-white'>
            <footer className="max-w-screen-xl mx-auto footer p-10 mx-auto">
                <nav>
                    <h6 className="footer-title">Services</h6>
                    <Link to="/shop" className="link link-hover">Design</Link>
                </nav>
                <nav>
                ...
                <nav>
                    ...
                    <Link to="/terms&condition" className="link link-hover">Privacy policy</Link>
                </nav>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-black max-w-screen-xl mx-auto text-white border-base-100">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Wallmate Gallery. <br />Providing you the best wallmate for your sweet home</p>
                </aside>
