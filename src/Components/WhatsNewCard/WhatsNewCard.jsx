...
const WhatsNewCard = ({product}) => {
  const { picture, name, about } = product;
  return (
    <div className="py-10 px-2">
      <div className="card lg:max-h-96 sm:max-h-52 lg:w-96 shadow rounded-none">
        <figure>
          <img src={picture} className="max-h-52 w-full" alt="Shoes" />
        </figure>
        <div className="card-body">
          <h2 className="card-title">{name} <div className="badge badge-secondary">NEW</div></h2>
          <p>{about}</p>
